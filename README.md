...
## 다국어 지원 (한국어 / 日本語 / English / 中文)
- **시스템 언어 자동 적용**: 처음 실행 시 휴대폰 언어에 맞게 설정·앱 이름(런처)이 자동 선택됩니다.
- 설정에서 4개 언어 중 수동 선택 가능 (선택 후 유지).
- 앱 이름: 정산앱 / 精算アプリ / Split Bill / 结算应用

## 사용 설명서 (매뉴얼)
- 🇰🇷 [한국어](docs/MANUAL_ko.md)
- 🇯🇵 [日本語](docs/MANUAL_ja.md)
- 🇺🇸 [English](docs/MANUAL_en.md)
- 🇨🇳 [中文](docs/MANUAL_zh.md)
