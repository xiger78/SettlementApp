...
data class AppStrings(
    ...
    val batchDeleteMeetings: (Int) -> String,
    ...
    val registerParticipants: String,
    val defaultMaleName: (Int) -> String,
    val defaultFemaleName: (Int) -> String,
    val saveParticipant: String,
    ...
    val genderTotalSumLabel: String,
    val genderTotalBreakdown: (Int, String, Int, String) -> String,
    val receipt: String,
    val capture: String,
    val recapture: String,
    val receiptHint: String,
    val receiptFileSize: (String) -> String,
    val deleteReceipt: String,
...
val KoStrings = AppStrings(
    ...
    selectAll = "전체 선택",
    deselectAll = "선택 해제",
    batchDeleteMeetings = { n -> "선택한 모임 ${n}건 삭제" },
    ...
    registerParticipants = "등록",
    defaultMaleName = { i -> "남자$i" },
    defaultFemaleName = { i -> "여자$i" },
    saveParticipant = "저장",
    ...
    clearField = "초기화",
    genderTotalSumLabel = "남녀 전체 합계",
    genderTotalBreakdown = { mCount, mSum, fCount, fSum ->
        "남 ${mCount}명 $mSum · 여 ${fCount}명 $fSum"
    },
    receipt = "영수증",
    capture = "촬영",
    recapture = "다시 촬영",
    receiptHint = "카메라로 영수증을 촬영하세요",
    receiptFileSize = { size -> "파일 크기: $size" },
    deleteReceipt = "사진 삭제",
...
val JaStrings = AppStrings(
    ...
    selectAll = "すべて選択",
    deselectAll = "選択解除",
    batchDeleteMeetings = { n -> "選択した集まり ${n}件を削除" },
    ...
    goSettlement = "精算へ進む",
    registerParticipants = "登録",
    defaultMaleName = { i -> "男性$i" },
    defaultFemaleName = { i -> "女性$i" },
    saveParticipant = "保存",
    ...
    clearField = "クリア",
    genderTotalSumLabel = "男女合計",
    genderTotalBreakdown = { mCount, mSum, fCount, fSum ->
        "男 ${mCount}名 $mSum · 女 ${fCount}名 $fSum"
    },
    receipt = "レシート",
    capture = "撮影",
    recapture = "再撮影",
    receiptHint = "カメラでレシートを撮影してください",
    receiptFileSize = { size -> "ファイルサイズ: $size" },
    deleteReceipt = "写真を削除",
