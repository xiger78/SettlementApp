...
data class AppStrings(
    ...
    val genderDiffLabel: String,
    val genderDiffNote: String,
    val genderDiffFormulaNote: String,
    val femalePerPersonLabel: String,
    val femalePerPersonResultLabel: String,
    val femaleSumNote: (Int, String) -> String,
    val balanceLabel: String,
    val malePerPersonLabel: String,
    val equalPerPersonLabel: String,
    val equalSplitNote: String,
    val maleFormulaNote: String,
    val resetSettlement: String,
    val resetSettlementHint: String,
    val receipt: String,
    val capture: String,
...
val KoStrings = AppStrings(
    ...
    genderDiffLabel = "남여차이 금액",
    genderDiffNote = "※ 남자 1인 = 여자 1인 + 남여차이 금액",
    genderDiffFormulaNote = "※ 여자 1인 = (정산금액 − 남여차이×남자수) ÷ 총인원",
    femalePerPersonLabel = "여자 1인 금액",
    femalePerPersonResultLabel = "여자 1인 금액 (자동계산)",
    femaleSumNote = { n, sum -> "여자 ${n}명 합계 $sum" },
    balanceLabel = "잔금액 (남자 부담 총액)",
    malePerPersonLabel = "남자 1인 금액 (자동계산)",
    equalPerPersonLabel = "1인 금액 (남녀 동일)",
    equalSplitNote = "※ 여자·남여차이 금액 미입력 시 총액을 참가 인원 수로 균등 분배합니다.",
    maleFormulaNote = "※ 여자 금액 입력 시: 남자 1인 = (정산금액 − 여자 합계) ÷ 남자 인원수",
    resetSettlement = "정산 초기화",
    resetSettlementHint = "정산 금액과 완료 상태가 초기화됩니다.",
    receipt = "영수증",
    capture = "촬영",
    recapture = "다시 촬영",
...
val JaStrings = AppStrings(
    ...
    genderDiffLabel = "男女差額",
    genderDiffNote = "※ 男性1人 = 女性1人 + 男女差額",
    genderDiffFormulaNote = "※ 女性1人 = (精算金額 − 男女差額×男性人数) ÷ 合計人数",
    femalePerPersonLabel = "女性 1人あたり金額",
    femalePerPersonResultLabel = "女性 1人あたり金額 (自動計算)",
    femaleSumNote = { n, sum -> "女性 ${n}名 合計 $sum" },
    balanceLabel = "残額 (男性負担の合計)",
    malePerPersonLabel = "男性 1人あたり金額 (自動計算)",
    equalPerPersonLabel = "1人あたり金額 (男女同額)",
    equalSplitNote = "※ 女性・男女差額未入力時は合計を参加人数で均等割りします。",
    maleFormulaNote = "※ 女性金額入力時: 男性1人 = (精算金額 − 女性合計) ÷ 男性人数",
    resetSettlement = "精算リセット",
    resetSettlementHint = "精算金額と完了状態がリセットされます。",
    receipt = "レシート",
    capture = "撮影",
    recapture = "再撮影",
